var Employees = /** @class */ (function () {
    ...
    Employees.prototype.createEmployee = function () {
        try {
            var premiiBrute = + $('#premii_brute').val();
            var totalBrut = $('#salary').val() * (1 + $('#spor').val() / 100) + premiiBrute;
            var cas = totalBrut * 0.25;
            var cass = totalBrut * 0.10;
            var brutImpozitabil = totalBrut - cas - cass;
            var impozit = brutImpozitabil * 0.10;
            var viratCard = totalBrut - impozit - cas - cass;
            var employee = {
