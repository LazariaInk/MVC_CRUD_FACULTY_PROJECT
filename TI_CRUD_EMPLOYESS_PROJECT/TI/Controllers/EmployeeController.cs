...
namespace IBJOffice.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        private readonly TIDbContext _db;

        public EmployeeController(TIDbContext db)
        {
            _db = db;
        }
        ...
        public async Task<IActionResult> SaveEmployee(Employee employee)
        {
            try
            {
                ...
                else
                {
                    ...
                    employeeFromDb.Spor = employee.Spor;
                    employeeFromDb.PremiiBrute = employee.PremiiBrute;
                    // employeeFromDb.ViratCard = 
